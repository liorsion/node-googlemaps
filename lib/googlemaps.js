...
exports.distance = function (origins, destinations, callback, sensor, mode, alternatives, avoid, units, language, departureTime) {
  var args = {
    'origins': origins,
...
exports.directions = function (origin, destination, callback, sensor, mode, waypoints, alternatives, avoid, units, language, departureTime, arrivalTime, region, optimize) {
  ...
  if (optimize) args.waypoints = 'optimize:true|'+args.waypoints;
